...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
  ...
  showHelp(outputElement = this.output) {
    ...
    const utilityCommands =
      ...
      this.wrapWithColor("• awards", "#98fb98") +
      "     " +
      this.wrapWithColor("View my awards and patents\n", "#ffffff") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Aspiring AI engineer with a passion for building",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
...
${this.wrapWithColor(
  "   Building scalable AI and IoT solutions to solve",
  "#ffffff"
)}
${this.wrapWithColor("   real-world problems and enhance UX/UI", "#ff8c00")}
...
<span style="color: #00ffff;">Launched Global | AI Intern</span>
${this.wrapWithColor(
  "Aug 2025 - Oct 2025",
  "#ffffff"
)}
...
• ${this.wrapWithColor("AI Development", "#ffa07a")} - ${this.wrapWithColor(
      "Built and deployed ML workflows using Python.",
      "#ffffff"
    )}

<span style="color: #00ffff;">Vital Skills | UX/UI Designer Intern</span>
${this.wrapWithColor(
  "Jun 2025 - Jul 2025",
  "#ffffff"
)}

• ${this.wrapWithColor("Design Prototypes", "#ffa07a")} - ${this.wrapWithColor(
      "Interactive human-centered design for apps.",
      "#ffffff"
    )}

<span style="color: #00ffff;">Global OSC | Open Source Contributor</span>
${this.wrapWithColor(
  "2024 - Present",
  "#ffffff"
)}

• ${this.wrapWithColor("Contributions", "#ffa07a")} - ${this.wrapWithColor(
      "Resolved issues & improved docs on Github.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, OpenCV, Figma, Github, ML Data Analysis",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:pranavkumar@gmail.com" style="color: #ffffff; text-decoration: none;">pranavkumar@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="#" style="color: #ffffff; text-decoration: none;">pranavkumar.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/pranavkumar" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/pranavkumar</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/pranavkumar" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/pranavkumar</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "SANTRUPTHI",
        description: "Sensor-enabled assistive canopy system to address maternal discomfort and lack of privacy during breastfeeding.",
        icon: "fas fa-baby",
      ...
      {
        title: "DHARMAJYOTI",
        description: "AI-based legal assistance platform simplifying complex legal documents for neurodivergent and low-literacy users.",
        icon: "fas fa-scale-balanced",
        technologies: ["AI", "NLP", "LegalBERT"],
        demo: "#",
        repo: "#",
      },
      {
        title: "AAHAR",
        description: "AI & IoT-Based Food Safety Detection System identifying harmful chemical adulterants in food.",
      ...
      {
        title: "KAVACH AI",
        description: "Intelligent fraud detection framework using behavioral analysis and graph-based intelligence.",
        icon: "fas fa-shield-halved",
        technologies: ["Graph Analytics", "ML", "Data Modeling"],
        demo: "#",
        repo: "#",
      },
      {
        title: "JIRYIA",
        description: "Voice-first assistive AI to support daily decision-making and natural language interaction.",
        icon: "fas fa-microphone-lines",
        technologies: ["AI", "Voice Recognition", "NLP"],
        demo: "#",
        repo: "#",
      },
      {
        title: "BHOOMI",
        description: "AI Smart Agriculture platform providing soil insights, crop planning, and sustainable farming.",
        icon: "fas fa-leaf",
        technologies: ["AI", "IoT", "Data Analytics"],
        demo: "#",
        repo: "#",
      }
    ];
  ...
  showAwards(outputElement = this.output) {
    const title = this.wrapWithColor("🏆 Awards & Patents\n\n", "#ffff00");
    const awardsText = 
      this.wrapWithColor("• 5× Patent Holder", "#00ffff") + " (Intellectual Property Authority | 2024-2026)\n" +
      "  Patents for SANTRUPTHI, DHARMAJYOTI, AAHAR, KAVACH, BHOOMI.\n\n" +
      this.wrapWithColor("• RRP Award 2026", "#00ffff") + " (Ministry of Corporate Affairs | 2026)\n" +
      "  Honored for tech solutions with significant societal impact.\n\n" +
      this.wrapWithColor("• Winner — National-Level Hackathon", "#00ffff") + " (IISc, Bangalore | 2025)\n" +
      "  1st place for delivering high-impact technical solution.\n\n" +
      this.wrapWithColor("• Winner — Flip the Case", "#00ffff") + " (IUCEE | 2025)\n" +
      "  1st place analytically strong solution.\n\n" +
      this.wrapWithColor("• Winner — Founder Pitch", "#00ffff") + " (ASPERA | 2025)\n" +
      "  1st place scalable startup concept.\n\n" +
      this.wrapWithColor("• International Representation", "#00ffff") + " (IEEE YESIST | Malaysia 2025)\n" +
      "  Presented innovative tech solutions representing India globally.\n\n" +
      this.wrapWithColor("• Appreciation Letter", "#00ffff") + " (ICON Awards | 2026)\n" +
      "  Recognition for innovation excellence.\n";

    const div = document.createElement("div");
    div.innerHTML = title + awardsText;
  ...
  showProjects() {
    ...
    container.innerHTML = this.projects
      ...
      <div class="project-card">
        <div class="project-image-placeholder" style="background: var(--terminal-highlight); height: 150px; display: flex; align-items: center; justify-content: center; font-size: 4rem; color: var(--text-bright); border-bottom: 1px solid var(--border-color);">
  ...
  async showWeather(location, outputElement) {
    ...
    try {
      ...
      const weatherHTML = `<div class="weather-container">
        ...
        <div class="weather-body">
          ...
          <div class="weather-details">
            <div><span style="color: #87cefa;">Feels like:</span> ${
              current.FeelsLikeC
            }°C</div>
            <div><span style="color: #87cefa;">Humidity:</span> ${
              current.humidity
            }%</div>
            <div><span style="color: #87cefa;">Wind:</span> ${
      ...
      this.printToOutput(
        outputElement,
        `Failed to fetch weather data: Could not find weather for "${location}". Please try another city.`,
        "error"
      );
    }
  }
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "pranav@kumar: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    role.textContent = "Aspiring AI Engineer • Student Ambassador • Innovator";
    ...
    url.textContent = "pranavkumar.me";
