...
class CloudDashboard {
    ...
    createSkillsCharts() {
        // AI & Data Skills Chart
        this.createSkillChart('cloudSkillsChart', {
            labels: ['Machine Learning', 'Python', 'NLP', 'OpenCV'],
            data: [85, 95, 75, 80],
        ...
        this.createSkillChart('programmingSkillsChart', {
            labels: ['C++', 'Python', 'Java', 'SQL'],
            data: [90, 95, 85, 75],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });

        // IoT & Devices Skills Chart
        this.createSkillChart('frameworksSkillsChart', {
            labels: ['IoT', 'Edge Compute', 'Sensors', 'Embedded'],
            data: [95, 90, 85, 75],
            colors: ['#FF6384', '#36A2EB', '#FFCE56', '#4BC0C0']
        });
    }
    ...
    initializeAllFeatures() {
        ...
        setTimeout(() => {
            this.addTypingEffect('.profile-title', 'Aspiring AI Engineer', 150);
        }, 2000);
    }
}
